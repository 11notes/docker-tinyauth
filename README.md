...
* [3.6.0](https://hub.docker.com/r/11notes/tinyauth/tags?name=3.6.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/tinyauth:3.6.0
docker pull ghcr.io/11notes/tinyauth:3.6.0
docker pull quay.io/11notes/tinyauth:3.6.0
```
